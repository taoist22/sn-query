...
# Purpose: Remove stale generated package artifacts before building
# Params: $1 project root
# Returns: none
# =========================================================
clean_build_artifacts() {
    local project_root="$1"
    write_color_output "Cleaning old build artifacts..." "Blue"
...
build_react_native_bundle() {
    ...
    local cmd="CI=1 npx react-native bundle --entry-file index.js --bundle-output \"$bundle_output\" --platform android --assets-dest \"$assets_dir\" --dev false"
